...
let addtask = async () => {
    ...
    if (newTask.task == "") {
        console.log(chalk.redBright("Please enter a valid task."));
    }
    else {
...
let deletetask = async () => {
    ...
    console.log(chalk.green(`Task ${deletetask} has been deleted successfully [you can check this from view list.]`));
};
//   UPDATE TASK
